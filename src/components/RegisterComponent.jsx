  ...
  return (
    <div>
      <div className="flex justify-center items-center mt-10  ">
        <div className=" w-[1287px] h-[834px] flex justify-evenly   rounded-4xl shadow-[0_4px_16px_rgba(0,0,0,0.15),_0_-1px_16px_rgba(0,0,0,0.15)] overflow-hidden">
          {/* Form Section */}
          <div className="w-1/2 p-8">
            <h2 className="text-3xl font-bold text-blue-custom mb-10 pt-24 ml-25">
              Sign Up to <span className="text-blue-custom">MY</span>
          ...
          <div className="">
            <img
              className="w-[546px] h-[774px] mt-7  "
