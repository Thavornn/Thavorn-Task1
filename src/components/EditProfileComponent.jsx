    ...
    <div className="ml-50">
      ...
      <div className="h-[542px] w-[1409px]   border border-gray-200 bg-white">
        <div>
          ...
          <div>
            {" "}
            <div className="grid grid-cols-2 gap-6 gap-y-10 ml-10 mt-10">
              <div>
      ...
      <div className="flex justify-end w-[1409px] p-3 mb-16 bg-white rounded-b-3xl shadow-lg border border-gray-200">
        <button className=" bg-[#183B4E] text-white px-10 py-2 rounded-lg hover:bg-blue-800 transition duration-200">
          Edit
        </button>
      </div>
    </div>
